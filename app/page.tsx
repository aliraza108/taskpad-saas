      ...
      <main className="max-w-6xl mx-auto px-6">
        <div className="py-20 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            <div className="bg-gray-50 rounded-2xl p-8 text-left hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Add, edit, and manage tasks in milliseconds. No waiting, no lag—just pure productivity.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 text-left hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Clean interface with smart filtering. Focus on what matters without the clutter.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 text-left hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Your tasks are encrypted and stored securely. Your data belongs to you, always.
              </p>
            </div>
          </div>
        </div>
